        ...
        <Card className='border-secondary' key={`cruise_${this.state.activeCruise.cruise_id}`}>
          <Card.Header>
            ...
            <div className='float-end'>
              <OverlayTrigger placement='top' overlay={<Tooltip id='cruiseMetricsTooltip'>Cruise Statistics</Tooltip>}>
                <FontAwesomeIcon
                  className='text-primary'
                  onClick={() => this.handleCruiseMetricsModal(this.state.activeCruise)}
                  icon='table'
                  fixedWidth
                  role='button'
                />
